      ...
      <div className="footer-inner">
        <div className="footer-columns">
          <div className="footer-column">
            <h3 className="footer-heading">My socials:</h3>
          ...
          <div className="footer-column">
            <h3 className="footer-heading">Archive:</h3>
            <p className="footer-text">Nothing archived yet...</p>
          </div>
          ...
          <div className="footer-column footer-column-contact">
            ...
            <p className="footer-text">
              <a href="mailto:s22bchua@gmail.com">s22bchua@gmail.com</a>
              <br />
              OR contact form <Link to="/contact">here</Link>
            </p>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <div className="footer-copy-wrap">
            <div className="footer-bottom-logo" aria-hidden>
              <img src={LogoFlat} alt="" />
            </div>
